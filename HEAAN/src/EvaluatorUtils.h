...
class EvaluatorUtils {
   public:
    ...
    static std::complex<double>* randomComplexArray(long size,
                                                    double bound = 1.0);

    static std::complex<double>* randomCircleArray(long size,
                                                   double bound = 1.0);
    ...
    static void leftRotateAndEqual(std::complex<double>* vals, const long n,
                                   const long r);

    static void rightRotateAndEqual(std::complex<double>* vals, const long n,
                                    const long r);
};
