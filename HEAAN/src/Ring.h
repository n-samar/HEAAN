...
class Ring {
   public:
    ...
    void decode(NTL::ZZ* mx, std::complex<double>* vals, long slots, long logp,
                long logq);
    ...
    void multDNTT(NTL::ZZ* x, uint64_t* a, uint64_t* rb, long np,
                  const NTL::ZZ& q);
    ...
    void multByConst(NTL::ZZ* res, NTL::ZZ* p, NTL::ZZ& cnst,
                     const NTL::ZZ& QQ);

    void multByConstAndEqual(NTL::ZZ* p, NTL::ZZ& cnst, const NTL::ZZ& QQ);

    void leftShift(NTL::ZZ* res, NTL::ZZ* p, const long bits,
                   const NTL::ZZ& QQ);
